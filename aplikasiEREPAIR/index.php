    ...
    <div class="wrapper">
        ...
        <section id="jenisjasa">
            <div class="tengah">
                <div class="kolom">
                    ...
                    <p>ERepair menyediakan jasa servis untuk segala macam barang elektronik dan transportasi.</p>
                </div>
        ...
        <section id="order">
            <div class="kolom-bawah reveal">
                ...
                <p>ERepair memberi kemudahan dan kecepatan bagi kamu untuk menemukan teknisi yang handal. Tanpa repot, tanpa bingung. Tidak perlu menunggu lebih lama lagi</p>
                <br>
        ...
        <section id="bantuan">
            <div class="pinggir kolom">
                <div class="head-qa">
                    <h2>BANTUAN<h2>
                    <h2>Q & A</h2>
                    <p>Membantu kalian untuk menjawab semua kendala permasalahan yang ada di applikasi ERepair</p>
                </div>
            <div class="form">
            <form>
        ...
        <div class="footer-wraper">
            <div class="footer">
                <div class="footer-section">
                    <h3>ERepair</h3>
                    <p>ERepair merupakan sebuah applikasi yang menyediakan jasa untuk perbaikan barang elektronik, seperti: laptop, hp, mesin cuci, tv, bahkan mobil dan lain-lainya.</p>
                </div>
                <div class="footer-section">
                    <h3>Contact</h3>
                    <p>No. telepon: 123-98576</p>
                    <p>Facebook   : Erepair </p>
                    <p>Twitter    : @ERepair</p>
                </div>
            </div>
        </div>
